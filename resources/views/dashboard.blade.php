...
<body>
    ...
    <div class="intro">
      <div class="intro-text">
        <h1 class="hide">
          <span class="text">Creating invation</span>
        </h1>
        <h1 class="hide">
          <span class="text">For people</span>
        </h1>
        <h1 class="hide">
  ...
  <div class="w3-row-padding">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">Barang 1</div>
          <div class = "zoom">
            <img src="/img/1.jpeg" alt="House" style="width:100%">
          </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">Barang 2</div>
          <div class = "zoom">
            <img src="/img/2.jpeg" alt="House" style="width:100%">
          </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">Barang 3</div>
          <div class = "zoom">
            <img src="/img/3.jpeg" alt="House" style="width:100%">
          </div>
      </div>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">Barang 4
        </div>
          <div class = "zoom">
            <img src="/img/1.jpeg" alt="House" style="width:100%">
          </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <figure class="effect-ravi">
                            <img src="/img/1.jpeg" alt="img17" />
                            <figcaption>
                                <h2>Satisfy <span>.co</span></h2>
                                <p>
...
<section class="py-5 text-center">
      <div class="container"> 
        <h2 class="text-center">Satisfy.co Services</h2>
